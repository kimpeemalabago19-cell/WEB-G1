...
/* 🔎 Only FOUND items */
$items = $conn->query("SELECT * FROM items WHERE status='found' ORDER BY created_at DESC");
?>

<!DOCTYPE html>
<html>
<head>
<title>Found Items - CHMSU Lost & Found</title>
<style>
...
.item-status { color:green; font-weight:bold; }
...
<?php while($row = $items->fetch_assoc()): ?>
    <div class="item-row">
        ...
        <div class="item-info">
            ...
            <div class="item-status"><?= strtoupper($row['status']) ?></div>
